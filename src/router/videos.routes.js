...
import { getLastVideo , getVideoByUserID , getVideoByTrickName, getVideoById, addVideo, addReaction, getReactionByUserIdAndVideoId} from "../controllers/videos.js";
...
router.get("/reaction/:user_id/:video_id", getReactionByUserIdAndVideoId);
